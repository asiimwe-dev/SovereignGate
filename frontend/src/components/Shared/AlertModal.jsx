...
import { AlertTriangle, Lock, ShieldAlert, RotateCcw, AlertOctagon, CornerDownRight, CheckSquare } from 'lucide-react';
      ...
      <div className="max-w-3xl w-full relative z-10 animate-in zoom-in-95 fade-in duration-300">
        ...
        <div className="institutional-card border-l-4 border-l-red-500 bg-[#0f131a] border-[#1f2937] overflow-hidden shadow-[0_0_80px_rgba(220,38,38,0.15)]">
          ...
          <div className="bg-gradient-to-r from-red-950/40 to-transparent px-6 py-5 sm:px-8 sm:py-6 flex items-center gap-4 border-b border-red-500/20">
            ...
            <div>
              <h1 className="text-base sm:text-lg font-black font-mono tracking-[0.1em] uppercase text-slate-100 flex items-center gap-2">
                RTGS System Isolation Active
              </h1>
              <p className="mt-0.5 text-red-400 font-mono text-[9px] uppercase tracking-widest font-black">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-4 sm:p-5">
              <div className="flex gap-2 text-red-400 items-start">
                ...
                <div className="space-y-1">
                  <p className="text-[10px] uppercase font-black tracking-wider leading-none">Security Invariant Triggered</p>
                  <p className="text-[9px] text-slate-300 font-mono leading-relaxed uppercase">
            ...
            <div className="space-y-3.5">
              <div className="flex items-center justify-between border-b border-[#1f2937] pb-2">
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                  <CornerDownRight size={10} className="text-red-500" /> Payload Forensic Comparison
                </span>
                <span className="text-[8px] font-mono text-slate-600 uppercase tracking-widest">INCIDENT_ID: SG-9021</span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-[#07090e] border border-emerald-500/15 p-4 rounded-xl relative overflow-hidden">
                  <div className="absolute top-0 right-0 bg-emerald-500/10 text-emerald-400 px-2.5 py-0.5 rounded-bl-xl text-[7px] font-black uppercase tracking-widest border-l border-b border-emerald-500/10">
                    Expected
                  </div>
                  <p className="text-[8px] text-emerald-500 font-mono font-black uppercase tracking-widest mb-3">Trusted Ledger seed</p>
                  
                  <div className="font-mono text-[10px] text-slate-300 bg-black/40 p-3.5 rounded-lg border border-[#1f2937] space-y-1.5">
                ...
                <div className="bg-red-950/10 border border-red-500/30 p-4 rounded-xl relative overflow-hidden">
                  <div className="absolute top-0 right-0 bg-red-600 text-white px-2.5 py-0.5 rounded-bl-xl text-[7px] font-black uppercase tracking-widest">
                    Mutated
                  </div>
                  <p className="text-[8px] text-red-400 font-mono font-black uppercase tracking-widest mb-3">Compromised record</p>
                  
                  <div className="font-mono text-[10px] text-slate-300 bg-black/40 p-3.5 rounded-lg border border-red-500/25 space-y-1.5">
            ...
            <div className="border-t border-[#1f2937] pt-5 flex flex-col sm:flex-row justify-between items-center gap-5">
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-1.5 self-start sm:self-center">
                <div className="flex items-center gap-2 text-slate-400 font-mono text-[9px] uppercase tracking-widest font-black">
              ...
              <button 
                ...
                disabled={restoring}
                className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-800 disabled:text-slate-600 text-black font-black text-[10px] uppercase tracking-[0.15em] px-5 py-3 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] cursor-pointer shadow-lg shadow-emerald-950/20 border border-emerald-500/35 hover:shadow-[0_0_15px_rgba(16,185,129,0.3)]"
              >
                {restoring ? (
                  <>
                    <div className="w-3.5 h-3.5 rounded-full border-2 border-slate-900 border-t-slate-100 animate-spin" />
                    Rolling Back...
                  </>
                ) : (
                  <>
          ...
          <div className="bg-[#07090e] border-t border-[#1f2937] px-6 py-3 text-center">
            <p className="text-[8px] font-mono text-slate-600 uppercase tracking-[0.2em] font-black">
